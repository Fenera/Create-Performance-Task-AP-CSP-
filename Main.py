...
list_of_answers = ["(a)Come to a complete stop | (b)Yield to oncoming traffic | (c)Drive through the intersection",
                   ...
                   "(a) Another vehicle is in your way | (b) It may help prevent a collision | (c) Another driver makes a mistake",
...
check_mark = pygame.image.load("C:/Program Files/Python39/python.exe" "//home01/students/2024/FT3035/Creative Performance Task(AP CSP)/assets/Main.py/check.png").convert_alpha()
check_mark = pygame.transform.scale(check_mark,(50, 50))
x_mark = pygame.image.load("C:/Program Files/Python39/python.exe" "//home01/students/2024/FT3035/Creative Performance Task(AP CSP)/assets/Main.py/incorrect.png").convert_alpha()
x_mark = pygame.transform.scale(x_mark, (50, 50))
